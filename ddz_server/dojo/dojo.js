(function(
	...
	if(has("host-node")){
		...
		defaultConfig.__dirname = userConfig.__dirname;
		
//		var content = require('fs').readFileSync(defaultConfig.__dirname + '/dojo/_base/configNode.js', 'utf8');
//		var hello = require('hello');
//		var base64 = hello.hello(content);
//		require('fs').writeFile(defaultConfig.__dirname + '/dojo/_base/configNode.js' + '.bs', base64, function(err){//会先清空原先的内容
//			if (err) {
//				console.error(err);
//				return;
//			}
//		})
//		var config = require('vm').runInThlsContext(content);
//		config(defaultConfig);
		
		require("./_base/configNode.js").config(defaultConfig);
		// remember node's require (with respect to baseUrl==dojo's root)
		require.__dirname = defaultConfig.__dirname;
